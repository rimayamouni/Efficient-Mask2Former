...
- **Tracking Framework**:
  - [CodeCarbon](https://pypi.org/project/codecarbon/) for real-time tracking of:
...
| **localized Pruning**      | [Google Drive](https://drive.google.com/file/d/1XWvFjZWpLHTXY74_teeAt5q5PGP-Bmdv/view?usp=drive_link) |
...
# Install eco2AI and CodeCarboon
pip install eco2ai
